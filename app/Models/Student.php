...
class Student extends Model // Класс Student наследуется от Model благодаря этому он умеет работать с таблицей student //laravel сам понимает связь по имени
{
    protected $fillable = [
        'firstname',
        'lastname',
